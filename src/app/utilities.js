...
.factory('UtilitiesFactory',
	...
	return {
		...
		flattenParseObj: function(parseObject){
			...
			function flatten(obj){
				if(obj && obj["attributes"] != null){
					var temp = process(obj["attributes"]);
					var temp = {
						id: obj.id
					};
					angular.extend(temp, obj["attributes"]);
					return temp;
				}
				return obj;
			}

			return flatten(parseObject);
		}
	}
});